...
define("CONTAINER_PATH", BASE_PATH.'/service-forum');
...
$pmLibPath = BASE_PATH.'/libraries/service-forum';
set_include_path($libPath.PATH_SEPARATOR.$commonLibPath.PATH_SEPARATOR.$pmLibPath);

require_once $libPath."/Zend/Application.php";
$application = new Zend_Application(APP_ENV, BASE_PATH.'/configs/forum/application.ini');
